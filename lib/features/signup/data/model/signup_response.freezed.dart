...
abstract class $SignUpResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? uuid, String? name, String? email});
}
...
/// @nodoc
@JsonSerializable()
class _$SignUpResponseImpl
    with DiagnosticableTreeMixin
    implements _SignUpResponse {
  const _$SignUpResponseImpl({this.uuid, this.name, this.email});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'SignUpResponse(uuid: $uuid, name: $name, email: $email)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, uuid, name, email);
...
abstract class _SignUpResponse implements SignUpResponse {
  const factory _SignUpResponse(
      {final String? uuid,
      final String? name,
      final String? email}) = _$SignUpResponseImpl;
